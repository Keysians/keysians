...
//! The Keysians Node runtime. This can be compiled with `#[no_std]`, ready for Wasm.
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("keysians"),
	impl_name: create_runtime_str!("keysians-node"),
	authoring_version: 1,
