...
use node_runtime::claims::EthereumAddress;
...
pub fn testnet_genesis(
	...
	GenesisConfig {
		...
		claims: Some(ClaimsConfig {
			claims: vec![
				(EthereumAddress(hex!["eb47855e47ee19985c2cb927edeb25bbf1225b12"]), STASH, None, None),
			],
			vesting: vec![],
		}),
	}
...
fn keysians_config_genesis() -> GenesisConfig {
	let initial_authorities: Vec<(AccountId, AccountId, GrandpaId, BabeId, ImOnlineId, AuthorityDiscoveryId)> = vec![
		(
		// //xxx//stash
		hex!["f679aadf81fda4abb6b2ee5020e1990bf0ef3a7d48636cb814d600f867755a41"].into(),
		// //xxx
		hex!["82c7545ea59b965e65a4dd44422affa2ce1c0fe575ed38a354f6be4961384c02"].into(),
		// //xxx ed25519
		hex!["be7076948435df6d664081cec9f7acfb4b57e9fbbf47524e6f4b9bc6541f01fc"].unchecked_into(),
		// //xxx
		hex!["82c7545ea59b965e65a4dd44422affa2ce1c0fe575ed38a354f6be4961384c02"].unchecked_into(),
		// //xxx
		hex!["82c7545ea59b965e65a4dd44422affa2ce1c0fe575ed38a354f6be4961384c02"].unchecked_into(),
		// //xxx
		hex!["82c7545ea59b965e65a4dd44422affa2ce1c0fe575ed38a354f6be4961384c02"].unchecked_into(),
...
/// Keysians config (single validator)
pub fn keysians_config() -> ChainSpec {
