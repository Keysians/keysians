...
pub fn create_full<C, P, M, SC>(
	...
	C::Api: pallet_assets_rpc::AssetsRuntimeApi<Block, TokenSymbol, AccountId, Balance>,
	C::Api: pallet_convert_rpc::ConvertRateRuntimeApi<Block, TokenSymbol, ConvertPrice>,
	C::Api: BabeApi<Block>,
	...
	SC: SelectChain<Block> +'static,
{
	...
	// register pallet-asset rpc handler
	io.extend_with(
		pallet_assets_rpc::AssetsApi::to_delegate(pallet_assets_rpc::Assets::new(client.clone()))
	);
	// register pallet-convert rpc handler
	io.extend_with(
		pallet_convert_rpc::ConvertPriceApi::to_delegate(pallet_convert_rpc::Convert::new(client))
	);
